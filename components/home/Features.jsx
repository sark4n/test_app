  ...
  return (
    <div className="py-12 bg-transparent overflow-hidden">
        <div className="container m-auto px-6 space-y-8 text-gray-500 md:px-12">
            ...
            {/* {Header} */}
            <div>
            <p className="blue_gradient text-5xl font-extrabold">Lo que necesitas en un solo sitio.</p>
            ...
            <div className="mt-16 grid border divide-x divide-y rounded-xl overflow-hidden sm:grid-cols-2 lg:divide-y-0 lg:grid-cols-3 xl:grid-cols-4">
                <Link href="/nuevapyme" className="relative group bg-transparent transition hover:z-[1] hover:shadow-2xl hover:bg-blue-100">
                    <div className="relative p-8 space-y-8 scale-90 transition duration-300 group-hover:scale-100">
                        ...
                        <div className="space-y-2">
                            <h5 className="text-xl blue_gradient font-extrabold transition group-hover:text-orange-600">¿Tienes una idea de negocio?</h5>
                ...
                <Link href="/mkt" className="relative group bg-transparent transition hover:z-[1] hover:shadow-2xl hover:bg-blue-100">
                    <div className="relative p-8 space-y-8 scale-90 transition duration-300 group-hover:scale-100 ">
                        ...
                        <div className="space-y-2">
                            <h5 className="text-xl blue_gradient font-extrabold transition group-hover:text-orange-600">Creamos tu sitio Web y potenciamos tus redes</h5>
                ...
                <Link href="/contale-legal" className="relative group bg-transparent transition hover:z-[1] hover:shadow-2xl hover:bg-blue-100">
                    <div className="relative p-8 space-y-8 scale-90 transition duration-300 group-hover:scale-100 ">
                        ...
                        <div className="space-y-2">
                            <h5 className="text-xl blue_gradient font-extrabold transition group-hover:text-orange-600">Asesoria Contable y Legal</h5>
                ...
                <Link href="/propiedades" className="relative group bg-transparent transition hover:z-[1] hover:shadow-2xl hover:bg-blue-100">
                    <div className="relative p-8 space-y-8 scale-90 transition duration-300 group-hover:scale-100 ">
                        ...
                        <div className="space-y-2">
                            <h5 className="text-xl blue_gradient font-extrabold transition group-hover:text-orange-600">Corredor de Propiedades</h5>
